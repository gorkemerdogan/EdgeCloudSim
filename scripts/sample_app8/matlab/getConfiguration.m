...
function [ret_val] = getConfiguration(argType)
    if(argType == 1)
        ret_val = 'C:\Users\ataha\Desktop\Edge Computing\Project\EdgeCloudSim-master\sim_results\sample_app8';
    elseif(argType == 2)
    ...
    elseif(argType == 7)
        ret_val = {'FIRST_FIT','BEST_FIT','WORST_FIT'}; %,'NETWORK_BASED','HYBRID'};
    elseif(argType == 8)
        ret_val = {'first', 'best', 'worst'}; %,'bw','hybrid'};
    elseif(argType == 9)
