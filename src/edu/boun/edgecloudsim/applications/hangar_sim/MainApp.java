			...
			for(int k=0; k<SS.getSimulationScenarios().length; k++)
			{
				for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
				{
					...
					try
					{
						...
						ScenarioFactory sampleFactory = new edu.boun.edgecloudsim.applications.hangar_sim.HangarSimScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario);
