...
public class AircraftHangarEdgeOrchestrator extends EdgeOrchestrator {

	private int numberOfHost; //used by load balancer

	public AircraftHangarEdgeOrchestrator(String _policy, String _simScenario) {
	...
	public int getDeviceToOffload(Task task) {
		int edgeLocation = task.getMobileDeviceId() % 3; // Determine the edge location
		return SimSettings.GENERIC_EDGE_DEVICE_ID + edgeLocation; // Process on edge
	}
...
//	}
	...
	public Vm getVmToOffload(Task task, int deviceId) {
		// For simplicity, always return the first VM of the device
		return SimManager.getInstance().getEdgeServerManager().getVmList(deviceId).get(0);
	}
